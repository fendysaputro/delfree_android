...
public class GpsTracking extends AppCompatActivity implements  GoogleApiClient.ConnectionCallbacks,
    ...
    private long FASTEST_INTERVAL = 50000; /* 5 minutes */
...
//        date.setText(date_n);
    ...
    public void onConnected(Bundle bundle) {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            //                                          int[] grantResults)
            // to handle the case where the driver grants the permission. See the documentation
